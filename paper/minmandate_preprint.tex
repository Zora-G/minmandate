...
% Combined arXiv entry point. The locked main paper and supplement sources are
% not modified; their document payloads are reproduced verbatim below.
...
% The locked main-paper tables were sized for a two-column page. Tighten only
% their inter-column padding in this single-column arXiv layout. The appendix
% installs its own table padding when it begins.
\AtBeginEnvironment{table*}{\let\small\footnotesize\setlength{\tabcolsep}{2pt}}
...
\captionsetup[table]{position=bottom,labelsep=colon}
\titleformat{\section}[block]{\large\sffamily\bfseries\color{MMHeading}}{\thesection}{0.65em}{}
\titlespacing*{\section}{0pt}{2.25ex plus 0.55ex minus 0.25ex}{0.9ex plus 0.2ex}
\titleformat{\subsection}[block]{\normalsize\sffamily\bfseries}{\thesubsection}{0.6em}{}
\titlespacing*{\subsection}{0pt}{1.75ex plus 0.4ex minus 0.2ex}{0.65ex plus 0.2ex}
\titleformat{\paragraph}[runin]{\normalsize\bfseries}{}{0pt}{}
\titlespacing*{\paragraph}{0pt}{1.15ex plus 0.25ex minus 0.15ex}{0.55em}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily MinMandate}
\fancyhead[R]{\small\sffamily Extended Manuscript}
\fancyfoot[C]{\thepage}
...
\author{Ge Gao, Haining Yu, Zhichao Liu,\\
Dongyang Zhan, Yuanxiao Zhu, Zhongyun Hua\\[0.35em]
\small Harbin Institute of Technology, China\\[0.25em]
\small \texttt{gaoge92021@163.com}; \texttt{yuhaining@hit.edu.cn}\\
\small \texttt{yaojialzc@gmail.com}; \texttt{zhandy@hit.edu.cn}\\
\small \texttt{24s103424@stu.hit.edu.cn}; \texttt{huazhongyun@hit.edu.cn}}
\hypersetup{
  pdftitle={MinMandate: Private Task-Scoped Payment Authorization for Adaptive Agent Workflows},
  pdfauthor={Ge Gao, Haining Yu, Zhichao Liu, Dongyang Zhan, Yuanxiao Zhu, Zhongyun Hua}
}
\affiliations{}
\maketitle
...
average, isolating the privacy cost of a stable join handle.
\end{abstract}
...
\ifdefined\MMAAAITwoColumn
  ...
  % Figure S1. The single-column entry retains its original narrative order.
